...
const ONBOARDING_STEPS = [
  {
    ...
    text: "Tour rapide en 5 étapes pour bien démarrer.<br><br>Tu peux <strong>réduire</strong> cette fenêtre à tout moment pour travailler.",
    nextLabel: 'Commencer →',
  ...
  },
  {
    ...
    text: "Importe <strong>au moins 3 GPX</strong> (idéalement 5-10) de tes sorties récentes. GPX manuel ou Strava.<br><br>Plus tu importes, plus les prédictions sont précises.",
  ...
  {
    id: 3, page: 'profil', selector: '.profil-kpis, .archetype-section',
    title: 'Étape 2/4 — Découvre ton profil',
    text: "Ton profil se construit automatiquement :<br><br>• <strong>VEP globale</strong> : vitesse éq. plat<br>• <strong>Archétype</strong> : Grimpeur, Descendeur…<br>• <strong>Score de pente</strong> : forces par terrain",
    nextLabel: 'Aller au simulateur →',
    nextAction: 'goto:simulateur',
  },
  {
    id: 4, page: 'simulateur', selector: '#dropzoneSim, .sidebar-sim, .sim-sidebar',
    title: 'Étape 3/4 — Simule une course',
    text: "Upload un GPX de course (UTMB, ta prochaine cible…) et lance la simulation.<br><br>L'algo prédit ton temps en tenant compte de la fatigue mécanique et de ton allure.",
    nextLabel: 'Compris !',
    nextAction: 'next',
  },
  {
    id: 5, page: 'simulateur', selector: '#btnPin, .btn-pin',
    title: 'Étape 4/4 — Épingle tes simulations',
    text: "Clique sur <strong>⭐ Épingler</strong> pour sauver une simulation.<br><br>Tu la retrouveras dans \"Mon compte\" pour la recalculer plus tard avec ton profil mis à jour.",
